  ...
  public async searchByImageBuffer(
    ...
    for (let idx = 0; idx < topMatches.length; idx++) {
      ...
      candidates.push({
        ...
        faceSimilarity: calculatedFaceSim === null ? null : Number(calculatedFaceSim.toFixed(3)),
        imageSimilarity: calculatedImageSim === null ? null : Number(calculatedImageSim.toFixed(3)),
        metadataScore,
        sourceSignalScore,
        finalScore,
        confidenceLabel,
